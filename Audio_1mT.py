...
#--------Physical Parameters------------------------------#  
geometry_type = 3 #Permanent magnets 
...
basedir = f'Single_Board/Test_Geom{geometry_type}_'+f'_{Np}sig_HPC'
...
timesteps = 1300
chosen_tags_list = [0,2,3,9,13,24,25,34,39,60]
corresponding_names_list = ['Bark', 'Finger-snapping', 'Run', 'Fart', 'Stream', 'Bus', 'Meow', 'Electric_guitar', 'Slam', 'Tick-tock']
